...
public struct MagnetometerData: BaseDbModelSQLite {
    public var id: Int64?
    ...
    public static let databaseTableName = "magnetometerData"
    ...
    public func toDictionary() -> Dictionary<String, Any> {
        ["id": id ?? -1, "timestamp": timestamp, "deviceId": deviceId, "label": label,
         ...
         "x": x, "y": y, "z": z, "eventTimestamp": eventTimestamp, "accuracy": accuracy]
    }
}
